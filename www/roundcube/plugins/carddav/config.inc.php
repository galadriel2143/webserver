...
$prefs['CardDAV'] = json_decode(getenv('CARDDAV_ADDRESSBOOK_PRESET') ?: 'null', true);

/*
    Example:

    CARDDAV_ADDRESSBOOK_PRESET={ "name": "CardDAV", "username": "%u", "password": "%p", "url": "https://localhost/card.php/", "active": true, "readonly": false, "refresh_time": "00:05:00", "fixed": ["name", "username", "password", "url", "hide"], "hide": true, }
 */
